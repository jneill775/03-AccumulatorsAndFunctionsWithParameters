...
#                get_bounding_box(), clone(), attach_to()
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                outline_color, outline_thickness, radius
#
...
#        necessary?  Why?
#            Without it, the window closes automatically as soon as the code is finished running.
#
